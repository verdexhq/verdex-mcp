...
import type { AncestorInfo, SiblingInfo } from "./types.js";
      ...
      return {
        tools: [
          ...
          },
          {
            ...
            description:
              "Explore the ancestry chain of an element to understand DOM hierarchy and ref containment",
            inputSchema: {
              type: "object",
              properties: {
                ref: {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                ancestorLevel: {
                  type: "number",
                  description:
                    "Which ancestor level to analyze siblings at (1 = direct parent, 2 = grandparent, etc.)",
                },
              },
