...
export function createSnapshot() {
    ...
    try {
        ...
        function processElement(el, indent = "", lastInteractiveRef = null, depth = 0) {
            ...
            if (!shouldInclude(el)) {
                console.log("Element not included, processing children with lastInteractiveRef:", lastInteractiveRef);
